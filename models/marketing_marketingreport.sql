...
SELECT 
    ...
    campaign_id,
    campaign_name,
    to_timestamp(SUBSTRING(campaign_start_date, 1, 10)::integer)::date as campaign_start_date,
    to_timestamp(SUBSTRING(campaign_end_date, 1, 10)::integer)::date as campaign_end_date,
